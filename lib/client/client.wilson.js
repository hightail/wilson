...
(function(window, angular, _) {
  ...
  var route = function(routeInfo) {
    if (_routeProvider && isLegalRoutingWindow) {
      ...
      var routingData = {
        controller: wilson.config.app.selectors.component + _.string.classify(routeInfo.component),
        resolve: {
          routeLabel: [function() {
...
//              $(angular.wilson.config.app.appLoaderSelector || '.loading-screen').css('display', 'block');
  ...
  var defineComponent = function(name, config) {
    var directiveName = wilson.config.app.selectors.component + _.string.classify(name);
    ...
    if (!_cache.components[directiveName]) {
      ...
      if(fullConfig.page) {
        ...
        wilsonController = ['ComponentFactoryService', '$injector', '$scope', function(ComponentFactoryService, $injector, $scope) {
          ...
          var $element = angular.element('.' + wilson.config.app.selectors.component + '-' + _.str.slugify(name));
  ...
  var defineBehavior = function(name, config) {
    var directiveName = wilson.config.app.selectors.behavior + _.string.classify(name);
