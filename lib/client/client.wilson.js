      ...
      var routingData = {
        ...
        resolve: {
          title:      ['$rootScope', 'IRouteService', function($rootScope, IRouteService) {
            return _.merge($rootScope, { page: { title: IRouteService.getTitleText(routeInfo.title) } });
          }],
          component:  ['$rootScope', '$route', '$q', '$location', '$window', 'AppStateService', 'IRouteService', 'ComponentLoaderService',
