    ...
    function createRoute(routeInfo, routes, routeProvider) {
      ...
      var routingData = {
        ...
        resolve: {
          ...
          $template:  ['$rootScope', '$route', '$q', '$location', '$window', 'AppStateService', 'WilsonRouter', 'ComponentLoaderService',
            function($rootScope, $route, $q, $location, $window, AppStateService, WilsonRouter, ComponentLoaderService) {
              ...
              return WilsonRouter.handleRouteChange(currentRoute, options, routeInfo).then(function() {
                ...
                if (routeInfo.title)  { $rootScope.page.title = WilsonRouter.getTitleText(routeInfo.title); }
