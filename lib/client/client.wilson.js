...
angular.wilson.service('ComponentFactoryService',
  ...
  function($rootScope, $timeout, StateMachineService, i18nextService, AppStateService, TranslationOverrideService, ComponentPrerenderService) {
    ...
    var init = function wilsonComponentInit(componentName, $scope, $element, $attrs, controller) {
      ...
      if (exposeName) { _parentComponentScope[exposeName] = $scope; }
...
(function(wilson, _) {
   ...
   */
  wilson.utils.spliceArray = function spliceArray(origArray, start, replace, arrayToSplice) {
  ...
  wilson.utils.replaceArray = function replaceArray(origArray, newArray) {
    wilson.utils.spliceArray(origArray, 0, origArray.length, newArray);
  };
  ...
  wilson.utils.clearArray = function clearArray(origArray) {
    wilson.utils.spliceArray(origArray, 0, origArray.length);
  };
...
(function(wilson, _) {
   ...
   * @param object
   */
  wilson.utils.clearObject = function clearObject(object) {
  ...
  wilson.utils.replaceObject = function replaceObject(object, newObject) {
    wilson.utils.clearObject(object);
