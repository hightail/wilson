    ...
    function createRoute(routeInfo, routes, routeProvider) {
      ...
      var routingData = {
        ...
        resolve: {
          ...
          $template:  ['$rootScope', '$route', '$q', '$location', '$window', 'AppStateService', 'IRouteService', 'ComponentLoaderService',
            function($rootScope, $route, $q, $location, $window, AppStateService, IRouteService, ComponentLoaderService) {
              ...
              return IRouteService.handleRouteChange(currentRoute, options, routeInfo).then(function() {
                ...
                else                                                    { return getComponentTag(routeInfo.component); }
