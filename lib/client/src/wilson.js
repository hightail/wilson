...
//      }
  ...
  var validateParams = function(type, name, definition, link) {
    ...
    var validateClassName = function(type, name) {
      ...
      if (type === 'service') {
        suffix = '[Service|Factory|Utility]';
      }
    ...
    if (_routeProvider && isLegalRoutingWindow) {
      ...
      var routingData = {
        ...
        resolve: {
          ...
          routeInfo: ['$route', '$location', 'AppStateService', 'IRouteService',
            function($route, $location, AppStateService, IRouteService) {
              ...
              isLocalRoute = IRouteService.handleRouteChange(currentRoute, options);
