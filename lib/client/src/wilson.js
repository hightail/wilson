...
(function(window, angular, _) {
  ...
  function Wilson(module) {
    ...
    function createPageLevelController(name, originalController, scriptDependencies) {
      return ['ComponentFactoryService', 'ResourceLoaderService', 'IRouteService', '$injector', '$scope',
        function(ComponentFactoryService, ResourceLoaderService, IRouteService, $injector, $scope) {
          var controller  = this;
