    ...
    function createRoute(routeInfo, routes, routeProvider) {
      ...
      var routingData = {
        ...
        resolve: {
          ...
          $template:  ['$rootScope', '$route', '$q', '$location', '$window', 'IRouteService', 'ComponentLoaderService', 'WilsonLogger',
            function($rootScope, $route, $q, $location, $window, IRouteService, ComponentLoaderService, WilsonLogger) {
              ...
              return IRouteService.handleRouteChange(currentRoute, options, routeInfo).then(function() {
                // Set or remove $rootScope page title
                ...
                return ComponentLoaderService.load(routeInfo.component).catch(function(error) {
                  WilsonLogger.log('Failed to load component [' + routeInfo.component + ']: Unknown server error.');
