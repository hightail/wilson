...
(function(window, angular, _) {
  ...
  function Wilson(module) {
    ...
    function createComponentController(name, controller, config) {
      return ['ComponentFactoryService', 'WilsonUtils', '$scope', '$element', '$attrs', '$transclude',
        function(ComponentFactoryService, WilsonUtils, $scope, $element, $attrs, $transclude) {
          ...
          _componentMap[componentId] = ComponentFactoryService.create(componentId, name, controller, this, parent, $scope, $element, $attrs, $transclude, config);
