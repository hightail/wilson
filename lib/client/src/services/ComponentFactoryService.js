...
angular.wilson.service('ComponentFactoryService',
  ['$rootScope', '$timeout', 'StateMachineService', 'BusFactoryService', 'i18nextService', 'AppStateService', 'TranslationOverrideService', 'ElementHelperService', 'ComponentPrerenderService',
  function($rootScope, $timeout, StateMachineService, BusFactoryService, i18nextService, AppStateService, TranslationOverrideService, ElementHelperService, ComponentPrerenderService) {
