...
//PartnerService = require('../core/PartnerService'),
...
module.exports = function(wilsonConfig) {
  ...
  var getConnectionFilterArray = function (tags) {
    ...
    _.each(tags, function (filterValue, filterName) {
      filters.push({ name: filterName, value: filterValue, priority: getFilterPriority(filterName)});
    });
...
//  };
  ...
  ///**
  // * Sets req.htConnectionFilters based on connection properties
  // */
  //var middleware = function(req, res, next) {
  //  PartnerService.getPartnerInfo(req).then(
  //    function(companyConfig) {
  //      decorateRequestClientInfo(req, res, next, companyConfig);
  //    },
  //    function(error) {
  //      // Use the default companyConfig
  //      logger.debug('Using default companyConfig since there was a problem getting companyConfig');
  //      decorateRequestClientInfo(req, res, next, req.htConfig.defaults.companyConfig);
  //    }
  //  );
  //};
